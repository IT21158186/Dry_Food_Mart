        ...
        <div class="col-span-full py-6 px-4 sm:py-12 lg:col-span-6 lg:py-24">
          <div class="mx-auto w-full max-w-lg">
            ...
            <form action="" class="mt-10 flex flex-col space-y-4">
              ...
              <div>
                <label for="card-name" class="sr-only">Address</label>
                <select id="card-name" name="card-name" placeholder="Address" class="mt-1 block w-full rounded border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500" >
